...
def run_BO_sigma(dataset_name):
  ...
  with open(f"bo_sigma_results_{dataset_name}.pkl", "wb") as f:
      pickle.dump(results_dict, f)

  print(f"Best sigma results saved to bo_sigma_results_{dataset_name}.pkl.")
  return results_dict
...
def BO_orth_reg(dataset_name):
  ...
  with open(f".bo_results_orth_{dataset_name}.pkl", "wb") as f:
      pickle.dump(best_params, f)
  print(f"Best results saved to bo_results_orth_{dataset_name}.pkl.")
  return best_params
